...
// // ----------------------------------------------------------------------------
// myLog(calculateTotalPrice([12, 85, 37, 4])); //138
// myLog(calculateTotalPrice([164, 48, 291])); //503
// myLog(calculateTotalPrice([412, 371, 94, 63, 176])); //1116

// ============================================================================

/** 11 ЗАДАЧА. ФІЛЬТРАЦІЯ МАСИВУ ЧИСЕЛ 2.0
Заміни оголошення функції filterArray() і колбек для методу forEach() на 
стрілочні функції.
*/
...
// //-----------------------------------------------------------------------------
// myLog(filterArray([1, 2, 3, 4, 5], 3)); //[4, 5]
// myLog(filterArray([1, 2, 3, 4, 5], 4)); //[5]
// myLog(filterArray([1, 2, 3, 4, 5], 5)); //[]
// myLog(filterArray([12, 24, 8, 41, 76], 38)); //[41, 76]
// myLog(filterArray([12, 24, 8, 41, 76], 20)); //[24, 41, 76]

// ============================================================================

/** 12 ЗАДАЧА. СПІЛЬНІ ЕЛЕМЕНТИ 2.0
Заміни оголошення функції getCommonElements() і колбек для методу forEach() 
